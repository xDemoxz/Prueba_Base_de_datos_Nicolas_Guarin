...
CREATE TABLE `riwi_branches` (
  ...
  KEY `fk_citie_branch` (`id_citie`),
  CONSTRAINT `fk_citie_branch` FOREIGN KEY (`id_citie`) REFERENCES `riwi_cities` (`id_citie`)
...
CREATE TABLE `riwi_cities` (
  `id_citie` int NOT NULL AUTO_INCREMENT,
...
CREATE TABLE `riwi_equipment_categories` (
  `id_EquipmentCategory` int NOT NULL AUTO_INCREMENT,
  `EquipmentCategory` varchar(100) NOT NULL,
  PRIMARY KEY (`id_EquipmentCategory`)
...
CREATE TABLE `riwi_equipments` (
  ...
  `id_EquipmentCategory` int DEFAULT NULL,
  PRIMARY KEY (`id_equipment`),
  KEY `fk_equipment_equipmentcategories` (`id_EquipmentCategory`),
  CONSTRAINT `fk_equipment_equipmentcategories` FOREIGN KEY (`id_EquipmentCategory`) REFERENCES `riwi_equipment_categories` (`id_EquipmentCategory`)
...
CREATE TABLE `riwi_orders` (
  `id_WorkOrder` int NOT NULL AUTO_INCREMENT,
  ...
  `cost` int NOT NULL,
  PRIMARY KEY (`id_WorkOrder`),
  KEY `fk_client_orders` (`id_client`),
  KEY `fk_technician_orders` (`id_technician`),
  KEY `fk_equipment_orders` (`id_equipment`),
  KEY `fk_service_orders` (`id_service`),
  KEY `fk_branch_orders` (`id_branch`),
  CONSTRAINT `fk_branch_orders` FOREIGN KEY (`id_branch`) REFERENCES `riwi_branches` (`id_Branch`),
  CONSTRAINT `fk_client_orders` FOREIGN KEY (`id_client`) REFERENCES `riwi_clients` (`id_client`),
  CONSTRAINT `fk_equipment_orders` FOREIGN KEY (`id_equipment`) REFERENCES `riwi_equipments` (`id_equipment`),
  CONSTRAINT `fk_service_orders` FOREIGN KEY (`id_service`) REFERENCES `riwi_services` (`id_service`),
  CONSTRAINT `fk_technician_orders` FOREIGN KEY (`id_technician`) REFERENCES `riwi_technicians` (`id_technician`)
...
--
-- Table structure for table `riwi_services`
--

DROP TABLE IF EXISTS `riwi_services`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
...
-- Dump completed on 2026-07-08  6:06:41
